...
class bikeAPI():
    ...
    def are_coordinates_within_distance(self, lat1, lon1, lat2, lon2, max_distance_km=5):
        """
        Determine if two GPS coordinates are within a specified distance (default 5 km).
        ...
        Returns:
        Boolean: True if points are within the specified distance, False otherwise
        """
